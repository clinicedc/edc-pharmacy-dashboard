...
class AppConfig(DjangoAppConfig):
    ...
    prescription_listboard_template_name = 'edc_pharmacy_dashboard/prescription_listboard.html'
    appointment_listboard_template_name = 'edc_pharmacy_dashboard/appointment_listboard.html'
    ...
    worklist_listboard_template_name = 'edc_pharmacy_dashboard/worklist_listboard.html'
